  ...
  return (
    <main >
      ...
      <div className="flex min-h-screen flex-col items-center p-24 px-48">
       ...
       <p className="text-xl font-serif top">Hi,{"\n"} I&aposm a Computer Science student at Concordia University, and previously at the University of Ottawa. I&aposm currently working on 2 projects (yet to be published).
